...
const SettingCard = ({
  ...
  <section
    className={clsx(
      "rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-200 dark:bg-gray-700 dark:ring-gray-600",
      className,
    )}
  >
    ...
    <BasePageLayout title="Settings">
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-3">
          <SettingCard title="Appearance" className="p-4 lg:h-full">
          ...
          <SettingCard title="Units" className="p-4 lg:h-full">
            <UnitSettings />
          </SettingCard>
        </div>
